export default {
	...
	IOTO_SYNC_SETTINGS: "Sync",
	IOTO_FETCH_SETTINGS: "Fetch",
	IOTO_SYNC_SETTINGS_Airtable: "Airtable",
	IOTO_SYNC_SETTINGS_Airtable_API_KEY: "API Key",
	IOTO_SYNC_SETTINGS_Airtable_API_KEY_HINT: "Set The Airtable API Key",
	IOTO_SYNC_SETTINGS_Airtable_BASE_ID: "Base ID",
	IOTO_SYNC_SETTINGS_Airtable_BASE_ID_HINT: "Set The Airtable Base ID",
	IOTO_SYNC_SETTINGS_Airtable_TABLE_ID: "Table ID",
	IOTO_SYNC_SETTINGS_Airtable_TABLE_ID_HINT: "Set The Airtable Table ID",
	IOTO_SYNC_SETTINGS_Vika: "Vika",
	IOTO_SYNC_SETTINGS_Vika_API_KEY: "API Key",
	IOTO_SYNC_SETTINGS_Vika_API_KEY_HINT: "Set The Vika API Key",
	IOTO_SYNC_SETTINGS_Vika_BASE_ID: "Base ID",
	IOTO_SYNC_SETTINGS_Vika_BASE_ID_HINT: "Set The Vika Base ID",
	IOTO_SYNC_SETTINGS_Vika_TABLE_ID: "Table ID",
	IOTO_SYNC_SETTINGS_Vika_TABLE_ID_HINT: "Set The Vika Table ID",
	IOTO_SYNC_SETTINGS_Feishu: "Feishu",
	IOTO_SYNC_SETTINGS_Feishu_APP_ID: "APP ID",
	IOTO_SYNC_SETTINGS_Feishu_APP_ID_HINT: "Set The Feishu APP ID",
	IOTO_SYNC_SETTINGS_Feishu_APP_SECRET: "APP Secret",
	IOTO_SYNC_SETTINGS_Feishu_APP_SECRET_HINT: "Set The Feishu APP Secret",
	IOTO_SYNC_SETTINGS_Feishu_BASE_ID: "Base ID",
	IOTO_SYNC_SETTINGS_Feishu_BASE_ID_HINT: "Set The Feishu Base ID",
	IOTO_SYNC_SETTINGS_Feishu_TABLE_ID: "Table ID",
	IOTO_SYNC_SETTINGS_Feishu_TABLE_ID_HINT: "Set The Feishu Table ID",
	IOTO_FETCH_SETTINGS_Airtable: "Airtable",
	IOTO_FETCH_SETTINGS_Airtable_API_KEY: "API Key",
	IOTO_FETCH_SETTINGS_Airtable_API_KEY_HINT: "Set The Airtable API Key",
	IOTO_FETCH_SETTINGS_Airtable_BASE_ID: "Base ID",
	IOTO_FETCH_SETTINGS_Airtable_BASE_ID_HINT: "Set The Airtable Base ID",
	IOTO_FETCH_SETTINGS_Airtable_TABLE_ID: "Table ID",
	IOTO_FETCH_SETTINGS_Airtable_TABLE_ID_HINT: "Set The Airtable Table ID",
	IOTO_FETCH_SETTINGS_Vika: "Vika",
	IOTO_FETCH_SETTINGS_Vika_API_KEY: "API Key",
	IOTO_FETCH_SETTINGS_Vika_API_KEY_HINT: "Set The Vika API Key",
	IOTO_FETCH_SETTINGS_Vika_BASE_ID: "Base ID",
	IOTO_FETCH_SETTINGS_Vika_BASE_ID_HINT: "Set The Vika Base ID",
	IOTO_FETCH_SETTINGS_Vika_TABLE_ID: "Table ID",
	IOTO_FETCH_SETTINGS_Vika_TABLE_ID_HINT: "Set The Vika Table ID",
	IOTO_FETCH_SETTINGS_Feishu: "Feishu",
	IOTO_FETCH_SETTINGS_Feishu_APP_ID: "APP ID",
	IOTO_FETCH_SETTINGS_Feishu_APP_ID_HINT: "Set The Feishu APP ID",
	IOTO_FETCH_SETTINGS_Feishu_APP_SECRET: "APP Secret",
	IOTO_FETCH_SETTINGS_Feishu_APP_SECRET_HINT: "Set The Feishu APP Secret",
